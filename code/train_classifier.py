...
from llm_classify.mdc_dataset import MDCDataset
from llm_classify.mdc_loader import MDCCollator, show_batch
from llm_classify.mdc_model import MDCModel, get_base_model
from llm_classify.mdc_optimizer import get_optimizer
from omegaconf import OmegaConf
from torch.utils.data import DataLoader
from tqdm.auto import tqdm
from utils.train_utils import EMA, AverageMeter, get_custom_cosine_schedule_with_warmup, get_lr, setup_training_run
...
@hydra.main(version_base=None, config_path="../conf/llm_classify", config_name="conf_baseline")
def run_training(cfg):
    ...
    # dataset ----
    train_ds = MDCDataset(cfg, train_df)
    valid_ds = MDCDataset(cfg, valid_df)
    ...
    scheduler = get_custom_cosine_schedule_with_warmup(optimizer=optimizer, num_warmup_steps=num_warmup_steps, num_training_steps=num_training_steps, decay_target=cfg.train_params.decay_target)
    ...
    if cfg.train_params.use_ema:
        ...
        accelerator.print(f"EMA will be used during evaluation with decay {round(decay_rate, 4)}...")
        print_line()
    ...
    if cfg.train_params.use_ema:
        accelerator.print("applying ema...")
        ema.apply_shadow()
